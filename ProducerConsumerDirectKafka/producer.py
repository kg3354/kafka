...
bootstrap_servers = os.getenv('KAFKA_BROKER_LIST', '10.33.69.8:31183,10.32.250.16:30347,10.32.250.21:30728')
#bootstrap_servers = os.getenv('KAFKA_BROKER_LIST', 'kafka.hsrn.nyu.edu:8082')
sasl_mechanism = os.getenv('KAFKA_SASL_MECHANISM', 'PLAINTEXT')
security_protocol = os.getenv('KAFKA_SECURITY_PROTOCOL', 'PLAINTEXT')  # Default to SASL_PLAINTEXT if not specified
